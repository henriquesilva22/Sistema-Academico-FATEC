...
export default function Footer() {
  return (
    <footer className="bg-[#1e3264] text-white w-full mt-auto">
        ...
        <ul className="list-disc space-y-2 text-white text-center md:text-left pl-5">
          ...
          <li>Telefone / WhatsApp: (19) 99999-9999</li>
       ...
       {/* 3 - Redes Sociais */}
        ...
        <li>
            ...
            <a href="https://instagram.com/fatecitapira" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex items-center space-x-2">
        ...
        {/* 4 - Logo + Softmare + Sistema Acadêmico */}
        <div className="flex flex-col items-center space-y-2">
          ...
          <span className="text-white text-center">Sistema Acadêmico v1.2 – Desenvolvido por Softmare</span>
        </div>
      </div>
    </footer>
  );
